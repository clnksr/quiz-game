...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.question_text = self.canvas.create_text(150, 125, text="", width=280, fill=THEME_COLOR, font=("Arial", 20, "italic"))
        self.canvas.grid(pady=50, column=0, row=1, columnspan=2)

        self.score_count = Label(text=f"Score: {self.quiz.score}", bg=THEME_COLOR, fg="white")
